...
public class ValidationProduto {
    ...
    public boolean validarCampos(JTextField TFproduto, JTextField TFpreco, JSpinner TFquantidade) {
        ...
        }else if(Integer.parseInt(String.valueOf(TFquantidade.getValue())) == 0){
            JOptionPane.showMessageDialog(null, "Favor informar a quantidade do produto", "Inválido", JOptionPane.WARNING_MESSAGE);
            return false;
        }
        return true;
